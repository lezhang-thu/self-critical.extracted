...
from misc.loss_wrapper_ppo import LossWrapper
from misc.rewards_ppo import init_scorer
...
def train(opt):
    ...
    if opt.checkpoint_path is not None and os.path.isfile(os.path.join(opt.checkpoint_path, 'infos_' + opt.id + '.pkl')):
